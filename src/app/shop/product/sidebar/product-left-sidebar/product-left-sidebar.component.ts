...
export class ProductLeftSidebarComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute, private router: Router,
    public productService: ProductService, private invS: InventoryService) { 
      // this.route.data.subscribe(response => alert(JSON.stringify(response.data)) );
      this.route.params.subscribe(params => {
        this.invS.singleInventory(params.id).subscribe((product: any) => {
